...
class BackendWidget(QWidget):
    def __init__(self, parent_ide):
        ...
        # === [NEW] BUTTON FOR EXPO PRESENTATION ===
        btn_load = QPushButton("📂 Load Routed"); btn_load.clicked.connect(self.load_routed_design); s_lay.addWidget(btn_load)
    ...
    # === [NEW] METHOD TO LOAD THE FINAL ROUTED FILE DIRECTLY ===
    def load_routed_design(self):
        ...
        if os.path.exists(def_path): 
            ...
            # Auto-enable useful layers for presentation
