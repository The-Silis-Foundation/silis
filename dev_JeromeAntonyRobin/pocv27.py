...
class SilisIDE(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Silis QT v3.4 (Guard Rails)")
    ...
    # --- SCHEMATIC GENERATION (FAILOVER SYSTEM + GUARD) ---
    def generate_schematic(self):
        ...
        if use_netlist:
            ...
            if os.path.exists(os.path.join(root, f"{base}.json")):
                env = os.environ.copy()
                env["NODE_OPTIONS"] = "--max-old-space-size=2048" # User Request: 2048
