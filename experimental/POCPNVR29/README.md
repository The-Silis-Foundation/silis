# Proof Of Concept PnR Version 29 - Quick Start Guide
...
pip install PyQt6 gdstk volare
sudo apt install xdotool wmctrl x11-utils psmisc 
# Optional (for better schematics)
sudo apt install nodejs npm
sudo npm install -g netlistsvg
sudo apt install librsvg2-bin
#kindly build GDS3D from source --> https://github.com/trilomix/GDS3D.git
```
...
Run the script by `python3 pocpnrv29.py`
...
**GDS3D viewer**
Located in the "GDS View (3D)" tab, this spawns a window of GDS3D 3d visualisation tools and pins it to silis IDE window (checkout [https://github.com/trilomix/GDS3D](https://github.com/trilomix/GDS3D))
<img width="1913" height="1076" alt="image" src="https://github.com/user-attachments/assets/31ae44c4-7978-4623-94ce-d27a086f1498" />
